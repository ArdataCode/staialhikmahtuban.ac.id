...
class Base {
    ...
    public function dpwap_plugin_register_menupage(){
        ...
        add_submenu_page( '', __( 'Multiple Upload', ' download-plugin' ), __(' Multiple Upload', 'download-plugin' ), 'manage_options', 'mul_upload', array( $this, 'dpwap_plugin_multiple_upload_func' ) );
    	add_submenu_page( '', __( 'Dpwap Activate', 'download-plugin' ), __(' Dpwap Activate', 'download-plugin' ), 'manage_options', 'dpwap-activate', array( $this, 'dpwap_plugin_package_activate_func' ) );
    	add_submenu_page( '', __( 'Dpwap Status', 'download-plugin' ), __(' Dpwap Status', 'download-plugin' ), 'manage_options', 'activate-status', array( $this, 'dpwap_plugin_all_activate_status_func' ) );
        add_submenu_page( '', __( 'Dpwap Plugin Download', 'download-plugin' ), __(' Dpwap Plugin Download', 'download-plugin' ), 'manage_options', 'dpwap_plugin_download', array( $this, 'dpwap_plugin_download_func' ) );
    }
    ...
    public function dpwap_plugin_download_link( $links, $plugin_file ) {
        ...
        $pluginDownloadLink = admin_url( 'admin.php?page=dpwap_plugin&dpwap_plugin_download='.$path.'&f='.$folder );
        $download_link = array(
